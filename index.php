	...
	<div class="container">
		...
		<div class="login">
			...
			<form action="index.php" method="post">
				<input type="text" Name="RollNo" placeholder="Roll Number" id ="focus" required="">
				<input type="password" Name="Password" placeholder="Password" required="">
			
			<br><br><a href="forget.php">Forgot Password?</a><br><br>
			<a href="#foc">Not Registered Yet?</a><br><br>
		...
		<div class="register">
			<h2>Sign Up</h2>
			<form action="index.php" method="post">
				<input type="text" Name="Name" placeholder="Name" required id="foc">
