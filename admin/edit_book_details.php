                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="uploadbookimg.php?id=<?php echo $bookid ?>" method="post" enctype="multipart/form-data">
                                    <div class="control-group">
                                        <label class="control-label" for="file"><b>Upload Book Photo</b></label>
                                        <div class="controls">
