...
$sql="select image from LMS.user where RollNo='ADMIN'";
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo $image?>" class="nav-avatar" />
                                <b class="caret"></b></a>
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="uploadadminimg.php?id=<?php echo $rollno ?>" method="post" enctype="multipart/form-data">
                                    <div class="control-group">
                                        <label class="control-label" for="file"><b>Upload Profile Photo</b></label>
                                        <div class="controls">
                                            <input type="file" id="file" name="file" class="span8" required>
                                        </div>
                                    </div>   

                                    <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn-primary"><center>Upload</center></button>
                                            </div>
                                        </div>
                                </form>
                        </div>
