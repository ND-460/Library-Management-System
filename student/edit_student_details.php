...
$r = $_SESSION['RollNo'];
$sql="select image from LMS.user where RollNo='$r'";
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="uploadstudentimg.php?id=<?php echo $rollno ?>" method="post" enctype="multipart/form-data">
                                    <div class="control-group">
